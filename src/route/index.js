...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'Середня загальноосвітня школа №230 м. Київ',
          isEnd: true,
        },
        {
          name: 'ДВНЗ "КНЕУ імені Вадима Гетьмана"',
          isEnd: true,
        },
        {
          ...
          projects: [
            {
              ...
              awards: [
                ...
                {
                  name: 'Preparing SEO optimizied pages.',
                },
              ],
              stackAmount: 5,
              awardAmount: 1,
